	...
	function search_query() {
		...
		// Translate to Gremlin query
	 	...
	 	var gremlin_query_edges = null;
	  	if (input_string==""){
	  		gremlin_query_nodes = "nodes = g.V().limit("+node_limit_per_request+").next()"
	  		gremlin_query_edges = "edges = g.V(nodes).bothE()"
			...
			gremlin_query_nodes = "nodes = g.V()."+has_str+".limit("+node_limit_per_request+").next()"
			gremlin_query_edges = "edges = nodes.bothE()"
